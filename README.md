...
### Etiquetas
`git tag <nombre de etiqueta>` -> crear etiqueta

`git tag <nombre de etiqueta> -m "<mensaje de etiqueta>"` -> crear etiqueta con mensaje

`git tag -d <etiqueta>` -> borrar una etiqueta
